            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="my-card-listing featured-listing">
                      <CardSlabItem v-for="item in featuredListingItems" :key="item.id" :itemdata="item" />
                    </ul>

                    <div class="empty-result" v-if="featuredListingItems.length == 0 && !requestInProcessFeatured">
