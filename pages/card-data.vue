  ...
  head() {
    return {
      ...
      meta: [
        ...
        // },
        {hid: 'card-og-title', name: 'og:title', content: this.metaTitle },
        { hid: 'card-og-image',name: 'og:image', content: this.metaImage },
        {
          hid: 'card-og-description',name: 'og:description',
          content: this.metaDesc,
        },
        { hid: 'card-og-url',name: 'og:url', content: this.currentUrl },
        { hid: 'card-og-site_name',name: 'og:site_name', content: 'Slabstox' },
        { hid: 'card-og-type',name: 'og:type', content: 'website' },

        { hid: 'card-article-published_time',name: 'article:published_time', content: (this.lastSaleDate!='N/A'?this.$moment(this.lastSaleDate).format('MMMM DD Y - hh:mm:ss A'):this.$moment().format('MMMM DD Y - hh:mm:ss A')) },
        { hid: 'card-article-author',name: 'article:author', content: 'Slabstox' },

        {hid: 'card-twitter-card', name: 'twitter:card', content: this.graphImage },
        { hid: 'card-twitter-url',name: 'twitter:url', content: this.currentUrl },
        { hid: 'card-twitter-title',name: 'twitter:title', content: this.metaTitle },
        { hid: 'card-twitter-image',name: 'twitter:image', content: this.metaImage },
        {
